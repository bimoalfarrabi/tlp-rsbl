...
<body>
    <div class="kop-surat">
        <h1>DAFTAR MEMORI EXTENSION RSUD BLAMBANGAN BANYUWANGI</h1>
    ...
    <div class="cara-pakai">
        <h4>Cara Pakai :</h4>
        <p>1. Menghubungi RSUD Blambangan ke kanto TU (Timur :) <span class="highlight">Tekan 55 (Suara Mesin) - Tekan
                Ext yang di tuju</span>)
        </p>
        <p>2. Menghubungi Kantor TU (Timur) ke RSUD Blambangan : <span class="highlight">Tekan 88 - Tekan Ext yang di
                tuju</span></p>
    </div>
</body>
