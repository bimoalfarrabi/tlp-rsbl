                    ...
                    render: function(data, type, row) {
                        return `
                            <div class="btn-group shadow-sm">
                                <button data-id="${row.id}" id="editDokter" class="btn btn-sm btn-white text-primary border-end" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button data-id="${row.id}" id="deleteDokter" class="btn btn-sm btn-white text-danger" title="Hapus">
